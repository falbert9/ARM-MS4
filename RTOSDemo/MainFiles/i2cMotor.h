#ifndef I2CMOTOR_TASK_H
#define I2CMOTOR_TASK_H
#include "vtI2C.h"
#include "lcdTask.h"
...
void vStarti2cMotorTask(vtMotorStruct *motorData,unsigned portBASE_TYPE uxPriority, vtI2CStruct *i2c,vtLCDStruct *lcd);
//
